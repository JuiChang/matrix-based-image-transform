...
if __name__ == "__main__":
    ...
    for i in range(nbh):
        ...
        for j in range(nbw):
            ...
            # print("our dft:\n", dft(block, blockSize))
            # exit()
            imgCof[i, j] = dft(block, blockSize)
    ...
    # basis = generateDftBasis(blockSize)
    ...
    #                     np.real(imgCof[i, j, u, v] * basis[:, :, u, v])
    ...
    for i in range(nbh):
        ...
        for j in range(nbw):
            ...
            reconsSubImg = reconstructDft(imgCof[i, j], blockSize)
            # print(reconstructDft(imgCof[i, j], blockSize))
